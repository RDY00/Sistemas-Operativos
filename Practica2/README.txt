...
Significa que un procesador está ejecutando las instrucciones del proceso en ese momento, es decir, que estas están pasando por el ciclo fetch-decode-execute.
...
Porque cuando se llama a la función switch_threads ambos hilos la estan ejecutando (como se comenta en switch.S), por lo que el tope del stack de ambos es igual (ambos tienen la llamada a esta función) y la EIP no requiere cambiarse pues se está ejecutando la misma función en el nuevo hilo.
